# Project VODKA (پروژه VODKA)

### The Ultimate Serverless Gateway on Cloudflare Workers

**VODKA** (Persian for *Hidden/Concealed*) is a secure, lightweight, and highly customizable reverse proxy that runs entirely on the edge. It transforms your Cloudflare Worker into a powerful, obfuscated gateway using **VLESS** or **Trojan** protocols, managed via a beautiful, self-contained Web UI.
...
VODKA isn't just a proxy script — it's a complete management solution designed for **stealth**, **speed**, and **ease of use**.
...
| 🌍 **Clean IP Multiplexer** | Input a list of clean Cloudflare IPs — VODKA auto-generates configs for all of them |
...
| 🔗 **Linked Panels (Other Nodes)** | Connect multiple VODKA panels securely with API Keys for cross-panel management and update propagation |
...
- **Web Installer:** [https://erpycode.github.io/VODKA-installer/](https://erpycode.github.io/VODKA-installer/)
...
2. Name it (e.g. `VODKA-core`) and click **Deploy**.
3. Click **Edit code**, delete the placeholder, and paste the full content of [`_worker.js`](https://github.com/itsyebekhe/VODKA/blob/main/_worker.js).
...
Recommended bot: [@VODKAproxyipbot](https://t.me/VODKAproxyipbot)

### Linked Panels (Other Nodes)

Connect external VODKA panels using **URL + API Key** for cross-panel management and update propagation.  
...
| Web Installer | [erpycode.github.io/VODKA-installer](https://erpycode.github.io/VODKA-installer/) |
...
[⭐ Star this repo](https://github.com/itsyebekhe/VODKA) · [🐛 Report a bug](https://github.com/itsyebekhe/VODKA/issues) · [🇮🇷 نسخه فارسی](./README_FA.md)
