...
<!-- LANG:FA -->
تمام تغییرات و بروزرسانی‌های پروژه VODKA (Project VODKA) در این فایل مستند خواهند شد.
<!-- LANG:FA -->
<!-- LANG:EN -->
All notable changes to Project VODKA will be documented in this file.
<!-- LANG:EN -->
...
### بهبود یافته (Improved)
- **پایداری فرم‌‌ها و اشتراک**: افزایش پایداری و اصلاح کنترل اعتبارهای سمت سرور و فرانت‌اند برای ارتقای امنیت و سرعت پنل VODKA.
<!-- LANG:FA -->
